<div class="profiles index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('workspace_prefs'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($profile['Profile']['workspace_prefs']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['email']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['first']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['last']); ?>&nbsp;</td>
		<td class="actions">
