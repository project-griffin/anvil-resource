...
<?php echo $this->Form->create('ResFolder'); ?>
	<fieldset>
		<legend><?php echo __('Edit Res Folder'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ResFolder.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ResFolder.id'))); ?></li>
